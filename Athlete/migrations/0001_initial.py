# Generated by Django 2.2.9 on 2020-02-01 23:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('athlete', models.ForeignKey(help_text='Athlete that participated', on_delete=django.db.models.deletion.CASCADE, to='Athlete.Athlete', verbose_name='Athlete')),
        ...
        migrations.AddField(
            model_name='athlete',
            name='noc',
            field=models.ForeignKey(help_text='National Olympic Committee represented by the Athlete', on_delete=django.db.models.deletion.CASCADE, to='Athlete.NOC', verbose_name='National Olympic Committee'),
        ),
    ]
